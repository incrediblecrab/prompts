...
After changes, compare contract copies, check relative links, and read representative combinations for conflicting or out-of-scope instructions. Local `scripts/` and `tests/` are intentionally untracked and are not required to use or maintain the library.
